...
for k=1:length(study_name)
    ...
    for i=1:p
        ...
        window.decision{length(window.label)+1} = [];
...
%                         saveas(gcf,['C:\Users\aungkon\Desktop\jhu\code\derived_figure_files\cocaine1\' num2str(pic) '.jpg'])
%                         close(figure1)
%                         pic = pic+1;
...
%                         saveas(gcf,['C:\Users\aungkon\Desktop\jhu\code\derived_figure_files\activity1\' num2str(pic1) '.jpg'])
%                         close(figure1)
%                         pic1 = pic1+1;
                            diff_median_array = [diff_median_array,median(diff(rr))];
                          range_array = [range_array,max(y)-min(y)];
...
save('all_features_baseline_corrected_monowar_model_outlier_diff_included.mat','theta_array','theta_label','duration_array','subject_array','taud_array','taur_array','f1_array','f2_array','var_array','LFHF_array','Power34_array',...
