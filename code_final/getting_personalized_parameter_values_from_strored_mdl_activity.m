...
load('C:\Users\aungkon\Desktop\jhu\code\derived_mat_files\accel_windows_with_parameters.mat');
...
%               
%           end
          accel_parameter.tau{k}(i) = mean(tau(~isnan(tau)));
          
           end
end
 save('C:\Users\aungkon\Desktop\jhu\code\derived_mat_files\accel_coeffs_mean_final.mat','accel_parameter');