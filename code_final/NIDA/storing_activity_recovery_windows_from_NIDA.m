...
for k=1:length(study_name)
        ...
        for i=1:p
            m1 = 1;
            for j=1:100
                if exist(['D:\Data\' char(study_name(k)) '\40_merge\' 'p' num2str(i,'%02d') '_s' num2str(j,'%02d') '.mat' ], 'file')== 2
                   load (['D:\Data\' char(study_name(k)) '\40_merge\' 'p' num2str(i,'%02d') '_s' num2str(j,'%02d') '.mat' ]);
...
save('C:\Users\aungkon\Desktop\jhu\code\code_final\NIDA\derived_mat_files\accel_windows.mat','accel_windows');