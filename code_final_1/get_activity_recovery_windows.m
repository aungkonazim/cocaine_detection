...
load('C:\Users\aungkon\Desktop\jhu\code\code_final_1\data\baseline_heart_rate_of_all_participants_interpolated.mat')
activity_windows = {};
       ...
       for i=1:p
            ...
            for j=1:22
                if exist(['C:\Users\aungkon\Desktop\jhu\' char(study_name(k)) '\40_merge\' 'p' num2str(i,'%02d') '_s' num2str(j,'%02d') '.mat' ], 'file')== 2
                   ...
                   y=C.rr.avg60.sample;
                   y_rest = baseline.heart_rate_sample_whole_day_wise{k}{i}{j};
...
save(['C:\Users\aungkon\Desktop\jhu\code\code_final_1\data\activity_windows.mat'],'activity_windows');