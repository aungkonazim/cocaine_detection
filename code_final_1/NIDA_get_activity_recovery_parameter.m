...
load('C:\Users\aungkon\Desktop\jhu\code\code_final_1\data_NIDA\activity_windows.mat');
activity_parameter ={};
for k=1:length(study_name)
        p = 46;
         for i=1:p
             if length(activity_windows.timestamp{k}{i}) > 0
           y_cell = {};
           x_cell = {};
           mdl_cell = {};
           range =[];
...
save(['C:\Users\aungkon\Desktop\jhu\code\code_final_1\data_NIDA\activity_parameter.mat'],'activity_parameter');