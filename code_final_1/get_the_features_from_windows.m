...
load('C:\Users\aungkon\Desktop\jhu\code\code_final_1\data\window_store.mat');
...
%     feature(m,24) = length(ya);
%     feature(m,23) = double(kurtosis(windows.act_sample{m})); %kurtosis of activation
    
%     feature(m,21)  = double(taur2); % ratio of estimated taur to real taur
%     feature(m,21)  = double(u/taud); % ratio of estimated taur to real taur
    
%    feature(m,20) = double(u); % ratio of u and u2
...
save(['C:\Users\aungkon\Desktop\jhu\code\code_final_1\data\feature.mat'],'feature','label','subject');